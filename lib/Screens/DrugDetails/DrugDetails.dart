...
class _DrugDetailsState extends State<DrugDetails> {
      ...
      children: <Widget>[
        ...
        new Positioned(
          ...
          child: new Container(
            ...
            child: new Center(
              child: setCommonText(
                  "\$30.00", AppColor.themeColor, 20.0, FontWeight.w700, 1),
            ),
          ),
        ),
        new Positioned(
                  ...
                  Positioned(
                      ...
                      child: Container(
                        ...
                        child: new Material(
                            ...
                            child: new Center(
                              child: setCommonText(
                                  SharedManager.shared.count.toString(),
                                  Colors.black54,
                                  14.0,
                                  FontWeight.w500,
                                  1),
        ...
        child: new ListView.builder(
          ...
          itemBuilder: (context, index) {
            return new Container(
              ...
              child: _setCommonViewForDrugDetails(
                  listDrugDetails[index]['title'],
                  listDrugDetails[index]['description']),
            );
          },
        ));
  }
        ...
        child: new Padding(
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              setCommonText(subtitle, Colors.grey, 15.0, FontWeight.w600, 10),
            ],
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    this.listDrugDetails = [
      {
        "title": AppTranslations.of(context).text(AppTitle.whatIsAtomic),
        "description": sampleText
      },
      {
        "title": AppTranslations.of(context).text(AppTitle.importantInfo),
        "description": sampleText
      },
      {
        "title": AppTranslations.of(context).text(AppTitle.sideEffets),
        "description": sampleText
      }
    ];
            ...
            slivers: <Widget>[
              SliverAppBar(
                ...
                flexibleSpace: new FlexibleSpaceBar(
                  centerTitle: true,
                  title: setCommonText(
                      "Atomic One", Colors.black, 18.0, FontWeight.w500, 1),
                  background: _setHeroAnimation(),
                ),
              ),
              SliverToBoxAdapter(
                  child: new Column(
                children: <Widget>[_setDrugDetailsView()],
              ))
            ],
          ),
        ),
        new Container(
          ...
          child: new InkWell(
            ...
            child: new Material(
              ...
              child: new Center(
                  child: setCommonText(
                      AppTranslations.of(context).text(AppTitle.buyNow),
                      Colors.white,
                      16.0,
                      FontWeight.w400,
                      1)),
