...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  List listData = [
        {"title":"dashbFindDoctor","icon":Icon(Icons.person,color:Colors.white,size: 40,),"availability":"doctorAvaliability","isSelect":true},
        {"title":"dashbFindHospital","icon":Icon(Icons.business,color:Colors.white,size: 40,),"availability":"hospitalAvaliability","isSelect":false},
        {"title":"dashbAppointment","icon":Icon(Icons.queue,color:Colors.white,size: 40,),"availability":"appointmentAvaliability","isSelect":false},
        ...
        {"title":"webRTC","icon":Icon(Icons.call,color:Colors.white,size: 40,),"availability":"withWebRTC","isSelect":false},
