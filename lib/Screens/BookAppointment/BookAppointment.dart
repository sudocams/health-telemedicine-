    ...
    return new Container(
      ...
      child: Column(
        children: <Widget>[
                      ...
                      child: new Container(
                        ...
                        child: new Material(
                          ...
                          child: new Padding(
                            ...
                            child: new Icon(Icons.phone_in_talk,
                                color: Colors.white),
                          ),
                        ),
                      ),
          ...
          setCommonText(
              PersonalInfo.name, Colors.black, 17.0, FontWeight.w600, 1)
        ],
      ),
    );
  }
        ...
        itemBuilder: (context, index) {
          return new Container(
            ...
            child: new Container(
              ...
              child: new Center(
                child: setCommonText(
                    "10.00 AM", AppColor.themeColor, 16.0, FontWeight.w500, 1),
              ),
            ),
          );
        },
            ...
            child: new InkWell(
              ...
              child: new Container(
                ...
                child: new Material(
                  ...
                  child: new Center(
                    child: new Text(
                      AppTranslations.of(context).text(AppTitle.bookNow),
                      style: new TextStyle(
                          color: Colors.white,
                          fontSize: 16,
      ...
      home: new Scaffold(
        ...
        appBar: new AppBar(
          ...
          title: setHeaderTitle(
              AppTranslations.of(context).text(AppTitle.bookAppointment),
              Colors.white),
