                ...
                child: new InkWell(
                  onTap: (){
                    Navigator.of(context,rootNavigator: false).push(MaterialPageRoute(builder: (context)=>BlogDetails(
                      title: AppTranslations.of(context).text(AppTitle.blogLifestyle),
                    )));
                  },
                  child: setCommonBlog(AppImage.blogFoodImage, "Can it usefull to your blured vision?", dummytext, width, width),
                ),
              ); 
            }),
          )
